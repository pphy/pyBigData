# Django settings for filepredict project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'clea',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7&=7ku!9gdrv)v6rj+hu%vu%kilum5@0ofi(7&_2#0rb^((-7f'
...
ROOT_URLCONF = 'filepredict.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'filepredict.wsgi.application'

import os
TEMPLATE_DIRS = (os.path.join(os.path.dirname(__file__), '..', 'templates').replace('\\', '/'),)
# TEMPLATE_DIRS = '/home/cutejumper/Documents/pyBigData/filepredict/templates',

STATIC_PATH = os.path.join(os.path.dirname(__file__), '../media').replace('\\', '/')
BOOTSTRAP_PATH = os.path.join(os.path.dirname(__file__), '../bootstrap').replace('\\', '/')
CLEANTHA_PATH = os.path.join(os.path.dirname(__file__), '../cleantha').replace('\\', '/')
