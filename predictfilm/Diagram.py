...
def drawDiagram():
    ...
    movieSearchFile = str(filesPath) + '/movieSearchNum.txt'
    movieBoxofficeFile = str(filesPath) + '/totalboxoffice.txt'
    weekSearchFile = str(filesPath) + '/weekSearchNum.txt'
    weekBoxofficeFile = str(filesPath) + '/weekboxoffice.txt'
    ...
    pylab.ylim(0.0, ylim)
    # pylab.show()# show the plot on the screen
    totalImagePath = str(imageFilesPath) + '/images/total.png'
    fig1.savefig(totalImagePath)
    ...
    # pylab.show()# show the plot on the screen
    weekImagePath = str(imageFilesPath) + '/images/week.png'
    fig2.savefig(weekImagePath)